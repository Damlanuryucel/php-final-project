				...
				<td>
					...
					<td>
						<a href="#editEmployeeModal" class="edit" data-toggle="modal">
							...
							data-cityname="<?php echo $row["cityname"]; ?>"
				...
				<form id="update_form">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="text" id="cityname_u" name="cityname" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Department</label>
						...
						<div class="form-group">
							<label>Email</label>
							<input type="email" id="mail_u" name="mail" class="form-control" required>
						</div>				
					</div>
					<div class="modal-footer">
